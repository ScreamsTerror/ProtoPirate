...
#define NISSAN_PROTOCOL_V0_NAME "Nissan V0"
...
extern const SubGhzProtocolDecoder subghz_protocol_nissan_decoder;
extern const SubGhzProtocolEncoder subghz_protocol_nissan_encoder;
extern const SubGhzProtocol nissan_protocol_v0;
...
SubGhzProtocolStatus subghz_protocol_decoder_nissan_deserialize(void* context, FlipperFormat* flipper_format);
